...
if(!accessBootstrap.includes('/saas-feedback-v1.js?v=20260920-6'))fail('feedback lazy loader missing');
...
if(!app.includes('access-bootstrap-v1.js?v=20260920-4'))fail('access bootstrap cache version not bumped');
...
if(!accessBootstrap.includes("/saas-settings-hub-v1.js?v=20260920-16"))fail('settings hub lazy loader missing');
