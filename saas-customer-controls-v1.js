...
function style(){if($('#lmCustomerControlsStyle'))return;const s=document.createElement('style');s.id='lmCustomerControlsStyle';s.textContent=`
#lmLeadSettingsModal{position:fixed;inset:0;z-index:13000;background:rgba(2,10,18,.76);display:grid;place-items:center;padding:18px}
#lmLeadSettingsModal .lmcc{width:min(920px,96vw);max-height:92vh;overflow:auto;background:#081923;color:#eaf4fb;border-radius:18px;border:1px solid rgba(115,164,193,.22);box-shadow:0 24px 70px rgba(0,0,0,.48);color-scheme:dark}
#lmLeadSettingsModal .lmh,#lmLeadSettingsModal .lmf{padding:18px 22px;border-bottom:1px solid rgba(115,164,193,.16)}
#lmLeadSettingsModal .lmh h2,#lmLeadSettingsModal .lmb h2{color:#f4fbff}
#lmLeadSettingsModal .sub{color:#9fb4c5}
#lmLeadSettingsModal .lmb{padding:22px}
#lmLeadSettingsModal .lmf{border-top:1px solid rgba(115,164,193,.16);border-bottom:0;display:flex;justify-content:flex-end;gap:8px;background:#0a1c27}
#lmLeadSettingsModal .grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}
#lmLeadSettingsModal label{display:block;font-size:12px;font-weight:750;color:#c7d7e3;margin:12px 0 5px}
#lmLeadSettingsModal input,#lmLeadSettingsModal textarea,#lmLeadSettingsModal select{width:100%;padding:10px;border:1px solid rgba(115,164,193,.24);border-radius:10px;background:#132733;color:#f4fbff;outline:none}
#lmLeadSettingsModal input:focus,#lmLeadSettingsModal textarea:focus,#lmLeadSettingsModal select:focus{border-color:#4de0b0;box-shadow:0 0 0 3px rgba(77,224,176,.12)}
#lmLeadSettingsModal input::placeholder,#lmLeadSettingsModal textarea::placeholder{color:#738b9d}
#lmLeadSettingsModal select option{background:#132733;color:#f4fbff}
#lmLeadSettingsModal .chips{display:flex;gap:7px;flex-wrap:wrap}
#lmLeadSettingsModal .chip{border:1px solid rgba(115,164,193,.22);background:#102430;color:#dbe8f2;border-radius:999px;padding:8px 10px;cursor:pointer}
#lmLeadSettingsModal .chip:hover{border-color:rgba(77,224,176,.46);background:#12303a}
#lmLeadSettingsModal .chip.on{border-color:rgba(77,224,176,.55);background:rgba(77,224,176,.14);color:#7cf0c7}
#lmLeadSettingsModal .choices{display:grid;grid-template-columns:1fr 1fr;gap:8px}
#lmLeadSettingsModal .choice{border:1px solid rgba(115,164,193,.22);background:#102430;color:#dbe8f2;border-radius:12px;padding:10px;cursor:pointer}
#lmLeadSettingsModal .choice strong{color:inherit}
#lmLeadSettingsModal .choice:hover{border-color:rgba(77,224,176,.46);background:#12303a}
#lmLeadSettingsModal .choice.on{border-color:rgba(77,224,176,.55);background:rgba(77,224,176,.14);color:#7cf0c7}
#lmLeadSettingsModal .note{padding:10px 12px;background:#102430;border:1px solid rgba(115,164,193,.18);border-radius:10px;color:#b8cad8}
#lmLeadSettingsModal .btn{border-color:rgba(115,164,193,.24);background:#102430;color:#eaf4fb}
#lmLeadSettingsModal .btn:hover{background:#15303d}
#lmLeadSettingsModal .btn.primary{background:#4de0b0;color:#06261d;border-color:#4de0b0;font-weight:800}
#lmLeadSettingsModal .btn.primary:hover{background:#66e7bd}
#lmLeadSettingsModal #lmccMsg{color:#9fb4c5}
@media(max-width:700px){#lmLeadSettingsModal .grid,#lmLeadSettingsModal .choices{grid-template-columns:1fr}}
`;document.head.appendChild(s)}
