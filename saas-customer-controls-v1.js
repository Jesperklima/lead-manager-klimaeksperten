...
function injectSettingsButton(){
  ...
  if(!card){
    ...
    view.prepend(card);
    card.querySelectorAll('[data-lm-pool-limit]').forEach(b=>b.addEventListener('click',()=>saveLeadPoolLimit(Number(b.dataset.lmPoolLimit))));
    $('#lmEditLeadSettings').onclick=openSettings;
  }
