...
window.addEventListener('lm:settings-open-request',()=>{try{activateSettings()}catch(e){console.warn('settings open',e)}});
window.LMSettingsHub={open:activateSettings,rehome};
