...
(()=>{
  ...
  window.addEventListener('pageshow',e=>{if(e.persisted)setTimeout(()=>silentRefresh(),100)});
    ...
    res.setHeader('X-Lead-Manager-Mode', 'stable-core+onboarding-v3+customer-controls-v1+lead-intake-v1+offer-intake-v1+response-panel-v1+feedback-v1+irrelevant-learning-v1+microsoft-v1+minuba-v1');
