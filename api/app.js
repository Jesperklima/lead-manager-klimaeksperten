...
(()=>{
  ...
  window.addEventListener('pageshow',e=>{if(e.persisted)setTimeout(()=>silentRefresh(),100)});
    ...
    res.setHeader('X-Lead-Manager-Mode', 'stable-core+onboarding-v3+customer-controls-v1+lead-intake-v1+offer-intake-v1+offer-search-controls-v2+response-panel-v1+feedback-v1+irrelevant-learning-v1+microsoft-v1+mail-providers-v1+mail-sender-name-v1+minuba-v1+credit-check-v1+marketing-leads-v1+marketing-connections-v1');
